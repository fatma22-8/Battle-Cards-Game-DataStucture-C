...
void play (){
 ...
 printf("\nplayer 1: (%d)", getLength(p1_head) );
    ...
    char type;
    int val;
    printf("Enter the type and the value of the card you want to pull it ");
     scanf("%C",&type);
    scanf("%d",&val);
...
if(getLength(p2)!=0)
      ...
      printf("\nPlayer 1 ATTACKs player 2 DEFENDs  \n");
        ...
        if(p1->value>p2->value){
            ...
            printf("Player 1 gets a new card. Player 2 loses his next card. \n");
...
if(getLength(p1_head)!=0)
        ...
        temp=p1->next;
            ...
            printf("Player 2 gets a new card. Player 1 loses his next card.  \n");
...
printf("INETRUCTIONS OF THE GAME\n");
